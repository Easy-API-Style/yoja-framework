...
public class TestWebResource_jar {

    @Test
    public void test_01() {
        final HttpClient httpClient = newHttpClient();
        
        final WebApp webApp = WebApp.jar("com.easygoingapi.yoja.http.server.test.web.resource");
    ...
    public void test_02() {
        ...
        final WebApp webApp = WebApp.jar("com.easygoingapi.yoja.http.server.test.web");
    ...
    public void test_09() {
        ...
        httpHeader.put("cAche-cOntrol", "max-age=10");
        final WebResource webResource_1 = new WebResource(webApp, "/*", httpHeader);
        final HttpRouter httpRouter =
            HttpRouter.builder()
                      .webResource(webResource_1)
                      .onResponse(h -> {
                          h.putHeader("cache-control", "max-age=6000");
                      })
                      .build();
        final HttpServer httpServer = newHttpServer(httpRouter);
        try {
            final HttpGet httpGet = HttpGet.builder("/webResource_1.txt")
                                           .build();
            final Future<HttpResponse> httpResponseFuture = httpClient.send(httpGet);
            final HttpResponse httpResponseClient = awaitValue(httpResponseFuture);
            assertEquals(false, httpResponseFuture.failed());
            assertEquals(200, httpResponseClient.statusCode());
            assertEquals("max-age=6000", httpResponseClient.header("Cache-Control"));
        }
        finally {
            await(httpServer.stop());
            assertTrue(httpServer.is(State.stopped));
    ...
    public void test_10() {
        ...
        try {
            ...
            assertEquals(false, httpResponseFuture.failed());
            assertEquals(200, httpResponseClient.statusCode());
            assertEquals("max-age=10", httpResponseClient.header("Cache-Control"));
        }
        finally {
            await(httpServer.stop());
            assertTrue(httpServer.is(State.stopped));
    ...
    public void test_11() {
        ...
        try {
            ...
            assertEquals(false, httpResponseFuture.failed());
            assertEquals(200, httpResponseClient.statusCode());
            assertEquals("no-store", httpResponseClient.header("Cache-Control"));
    ...
    public void test_12() {
        ...
        final HttpRouter httpRouter =
            HttpRouter.builder()
                      .contentType("txt", ContentType.text.value())
                      .webResource(webResource_1)
                      .build();
        final HttpServer httpServer = newHttpServer(httpRouter);
        try {
    ...
    public void test_13() {
        ...
        final HttpServer httpServer = newHttpServer(httpRouter);
        try {
            final HttpGet httpGet = HttpGet.builder("/webResource_2.js")
                                           .build();
            final Future<HttpResponse> httpResponseFuture = httpClient.send(httpGet);
            final HttpResponse httpResponseClient = awaitValue(httpResponseFuture);
            assertEquals(false, httpResponseFuture.failed());
    ...
    public void test_15() {
        ...
        final HttpServer httpServer = newHttpServer(httpRouter);
        try {
            final HttpGet httpGet = HttpGet.builder("/webResource_1")
                                           .build();
            final Future<HttpResponse> httpResponseFuture = httpClient.send(httpGet);
            final HttpResponse httpResponseClient = awaitValue(httpResponseFuture);
            assertEquals(false, httpResponseFuture.failed());
