...
[![Maven Central](https://img.shields.io/badge/maven--central-com.easygoingapi%3Ayoja--web%3A1.4.0-blue)](https://central.sonatype.com/artifact/com.easygoingapi/yoja-web/1.4.0)
...
```html
<script type="module"
        src="/com/easygoingapi/yoja/web/YojaWeb-1.4.0.js"
...
The class is defined in [`YojaWeb-1.4.0.js`](src/main/webapp/com/easygoingapi/yoja/web/YojaWeb-1.4.0.js) (search for `class Section`). It is **not exported** as a public symbol — you never construct one yourself. The framework instantiates a `Section` for every DOM element that carries at least one section-creating directive (`yw-controler`, `yw-css`, `yw-language`, or `yw-slot`), and hands it to your controller's constructor as the single argument.
