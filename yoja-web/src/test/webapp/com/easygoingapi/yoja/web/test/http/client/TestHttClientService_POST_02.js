...
const result = await httpClient.post('/post_01', new Blob([JSON.stringify({key_01: 'value_01', key_02: 'value_02'})], {type : 'application/json'}))  

const response = await result.body.text()
ywAssert.assertEquals('application/json', result.body.type)
