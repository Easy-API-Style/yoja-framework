...
[![Maven Central](https://img.shields.io/badge/maven--central-com.easygoingapi%3Ayoja--selenium%3A1.0.1-blue)](https://central.sonatype.com/artifact/com.easygoingapi/yoja-selenium/1.0.1)
...
The built-in page loads `YojaWeb.js` with `yw-config-path="/YojaWeb.conf.js"`. To configure yoja-web in tests, serve a `/YojaWeb.conf.js` file from the embedded server:
