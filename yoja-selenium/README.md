...
[![Maven Central](https://img.shields.io/badge/maven--central-com.easygoingapi%3Ayoja--selenium%3A1.3.0-blue)](https://central.sonatype.com/artifact/com.easygoingapi/yoja-selenium/1.3.0)
...
The built-in page loads `YojaWeb-1.3.0.js` with `yw-config-path="/YojaWeb.conf.js"`. To configure yoja-web in tests, serve a `/YojaWeb.conf.js` file from the embedded server:
